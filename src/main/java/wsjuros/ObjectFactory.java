 ...
 * generated in the wsjuros package. 
...
public class ObjectFactory {
    ...
    private final static QName _JuroSimples_QNAME = new QName("http://juros.ws/", "juroSimples");
    private final static QName _MontanteJuroCompostoResponse_QNAME = new QName("http://juros.ws/", "montanteJuroCompostoResponse");
    private final static QName _JuroCompostoResponse_QNAME = new QName("http://juros.ws/", "juroCompostoResponse");
    private final static QName _MontanteJuroSimples_QNAME = new QName("http://juros.ws/", "montanteJuroSimples");
    private final static QName _MontanteJuroSimplesResponse_QNAME = new QName("http://juros.ws/", "montanteJuroSimplesResponse");
    private final static QName _JuroSimplesResponse_QNAME = new QName("http://juros.ws/", "juroSimplesResponse");
    private final static QName _JuroComposto_QNAME = new QName("http://juros.ws/", "juroComposto");
    private final static QName _MontanteJuroComposto_QNAME = new QName("http://juros.ws/", "montanteJuroComposto");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: wsjuros
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juros.ws/", name = "juroSimples")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juros.ws/", name = "montanteJuroCompostoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juros.ws/", name = "juroCompostoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juros.ws/", name = "montanteJuroSimples")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juros.ws/", name = "montanteJuroSimplesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juros.ws/", name = "juroSimplesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juros.ws/", name = "juroComposto")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juros.ws/", name = "montanteJuroComposto")
